* master
** Reportes de cartera son vistas sqlalchemy. Se arreglaron los filtros de busqueda
...
** Se modificó la vista del reporte de cheques entregados como un select de sqlalchemy
