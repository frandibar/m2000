...
*** como setear valor por default para una imagen.
...
*** como hacer para que un filtro de un propertycolumn booleano muestre true y false en vez de 1 y 0?
...
*** los columnproperty no se necesitan siempre y sin embargo lo calculamos todo el tiempo. se puede evitar esto?
** MISC
